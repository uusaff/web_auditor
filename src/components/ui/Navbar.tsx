          ...
          {isDropdownOpen && (
            <div className="absolute right-0 mt-3 w-56 bg-[#151f18]/95 border border-white/10 rounded-2xl shadow-2xl py-2 flex flex-col backdrop-blur-xl overflow-hidden z-50">
              ...
              <div className="md:hidden flex flex-col border-b border-white/10 pb-1 mb-1">
                ...
                <Link href="/new-audit" onClick={() => setIsDropdownOpen(false)} className={`px-4 py-2.5 text-sm transition-colors block uppercase ${pathname === '/new-audit' ? 'text-[#ccb999] font-bold' : 'text-white/80 hover:text-white hover:bg-white/5'}`}>New Audit</Link>
