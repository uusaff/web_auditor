              ...
              {isResettingPassword ? (
                ...
                >
                  <div className="space-y-1">
                    <label htmlFor="reset-email" className="text-xs text-white/50 uppercase tracking-widest ml-4">Email Address</label>
                    <input
                      id="reset-email"
                      name="email"
                      aria-label="Email Address for Reset"
                      aria-required="true"
                      type="email"
                      value={email}
                      onChange={(e) => setEmail(e.target.value)}
                      className="w-full h-14 rounded-full bg-white/5 border border-white/10 px-6 text-white placeholder:text-gray-400 focus:outline-none focus:border-sky-400/50 focus:bg-white/10 transition-all"
                  ...
                  <button
                    ...
                    className="w-full h-14 mt-4 bg-sky-400 text-black rounded-full font-bold tracking-widest uppercase hover:bg-sky-500 transition-colors disabled:opacity-50"
                  >
